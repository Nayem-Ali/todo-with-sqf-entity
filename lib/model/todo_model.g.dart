...
class TableTodo extends SqfEntityTableBase {
  TableTodo() {
    ...
    fields = [
      ...
      SqfEntityFieldBase('isDone', DbType.bool, defaultValue: false),
    ];
    super.init();
  }
...
class TodoDatabaseModel extends SqfEntityModelProvider {
  TodoDatabaseModel() {
    databaseName = myDatabaseModel.databaseName;
    password = myDatabaseModel.password;
    dbVersion = myDatabaseModel.dbVersion;
    preSaveAction = myDatabaseModel.preSaveAction;
    logFunction = myDatabaseModel.logFunction;
    databaseTables = [
    ...
    bundledDatabasePath = myDatabaseModel
        .bundledDatabasePath; //'assets/sample.db'; // This value is optional. When bundledDatabasePath is empty then EntityBase creats a new database when initializing the database
    databasePath = myDatabaseModel.databasePath;
  }
...
class Todo extends TableBase {
  ...
  Todo.withFields(this.title, this.isDone) {
    _setDefaultValues();
  }
  Todo.withId(this.id, this.title, this.isDone) {
    _setDefaultValues();
  }
  // fromMap v2.0
  Todo.fromMap(Map<String, dynamic> o, {bool setDefaultValues = true}) {
    ...
    if (o['isDone'] != null) {
      isDone =
          o['isDone'].toString() == '1' || o['isDone'].toString() == 'true';
    }
  }
  // FIELDS (Todo)
  int? id;
  ...
  Map<String, dynamic> toMap(
    ...
    if (isDone != null) {
      map['isDone'] = forQuery ? (isDone! ? 1 : 0) : isDone;
    } else if (isDone != null || !forView) {
      map['isDone'] = null;
    }
  ...
  Future<int?> upsert({bool ignoreBatch = true}) async {
    try {
      final result = await _mnTodo.rawInsert(
          'INSERT OR REPLACE INTO todo (id, title, isDone)  VALUES (?,?,?)',
          [id, title, isDone],
          ignoreBatch);
      if (result! > 0) {
...
class TodoFilterBuilder extends ConjunctionBase {
  ...
  TodoField? _isDone;
  TodoField get isDone {
    return _isDone = _setField(_isDone, 'isDone', DbType.bool);
  }
...
class TodoFields {
  ...
  static TableField? _fIsDone;
  static TableField get isDone {
    return _fIsDone =
        _fIsDone ?? SqlSyntax.setField(_fIsDone, 'isDone', DbType.bool);
  }
}
...
class IdentitySequence {
  ...
  Future<int> nextVal([VoidCallback Function(int o)? nextval]) async {
    final val = await TodoDatabaseModelSequenceManager()
